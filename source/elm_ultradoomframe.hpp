...
// Version label shown on the overlay header. Falls back to a default when the
// build system doesn't pass -DAPP_VERSION="..." (Ethan's UltraDoom-Overlay
// Makefile sets it; this project's Makefile doesn't yet).
#ifndef APP_VERSION
